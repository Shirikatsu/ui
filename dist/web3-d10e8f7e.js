...
const ETHERSCAN_TYPES = new Map([['block', 'block'], ['transaction', 'tx'], ['address', 'address'], ['token', 'token']]);
...
function blockExplorerUrl(type, value, {
  ...
  try {
    ...
    environment.warn(`blockExplorerUrl(): ${err.message}`);
    return '';
  }
}
/**
...
//# sourceMappingURL=web3-d10e8f7e.js.map
