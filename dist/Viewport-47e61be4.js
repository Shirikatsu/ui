...
function isSymbol(value) {
  return typeof value == 'symbol' ||
    (isObjectLike_1(value) && _baseGetTag._baseGetTag(value) == symbolTag);
}
...
const ViewportContext = /*#__PURE__*/React__default['default'].createContext(WINDOW_SIZE_BASE);
...
class ViewportProvider extends React__default['default'].Component {
  constructor(...args) {
    super(...args);
    ...
    defineProperty._defineProperty(this, "updateWindowSize", () => {
      this.setState({
        windowSize: this.getWindowSize()
      });
    });

    defineProperty._defineProperty(this, "within", (min, max) => {
      const {
        width
    ...
    defineProperty._defineProperty(this, "above", value => this.within(value, -1));

    defineProperty._defineProperty(this, "below", value => this.within(-1, value));
  }
...
defineProperty._defineProperty(ViewportProvider, "propTypes", {
  children: index.propTypes.node,
  throttle: index.propTypes.number
});

defineProperty._defineProperty(ViewportProvider, "defaultProps", {
  throttle: 100
});

const Viewport = props => /*#__PURE__*/React__default['default'].createElement(ViewportContext.Consumer, props);

Viewport.Provider = ViewportProvider;
const useViewport = () => React__default['default'].useContext(ViewportContext);

exports.Viewport = Viewport;
exports.useViewport = useViewport;
//# sourceMappingURL=Viewport-47e61be4.js.map
