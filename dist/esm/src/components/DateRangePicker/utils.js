...
function handleDateSelect({
  ...
  const isValidStartDate = !endDate || !dayjs_min(date).isAfter(endDate);
  const isValidEndDate = !startDate || !dayjs_min(date).isBefore(startDate); // if we have startDate, then `date` is the end date
